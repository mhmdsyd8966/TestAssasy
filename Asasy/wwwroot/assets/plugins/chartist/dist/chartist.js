...
(function(window, document, Chartist){
  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      if(seriesOptions.showArea && axisY.range) {
        ...
        var areaAsasyed = chartRect.y1 - axisY.projectValue(areaBase);
        ...
        path.splitByCommand('M').filter(function onlySolidSegments(pathSegment) {
          ...
          return solidPathSegments.clone(true)
            .position(0)
            .remove(1)
            .move(firstElement.x, areaAsasyed)
            .line(firstElement.x, firstElement.y)
            .position(solidPathSegments.pathElements.length + 1)
            .line(lastElement.x, areaAsasyed);
  ...
  Chartist.Line = Chartist.Asasy.extend({
    constructor: Line,
...
(function(window, document, Chartist){
  ...
  Chartist.Bar = Chartist.Asasy.extend({
    constructor: Bar,
    createChart: createChart
  });
...
(function(window, document, Chartist) {
  ...
  Chartist.Pie = Chartist.Asasy.extend({
    constructor: Pie,
    createChart: createChart,
